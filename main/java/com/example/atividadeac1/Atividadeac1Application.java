    ...
    public CommandLineRunner init(
        ...
        return args -> {
            ...
            Categoria cat1 = categoriaRepository.salvar(
                    new Categoria(null, "Eletrônicos", "Produtos eletrônicos diversos"));
            Categoria cat2 = categoriaRepository.salvar(
                    new Categoria(null, "Vestuário", "Roupas e acessórios de moda"));
            ...
            produtoRepository.salvar(
                    new Produto(null, "Smartphone", 10, cat1));
            produtoRepository.salvar(
                    new Produto(null, "Camiseta", 50, cat2));
